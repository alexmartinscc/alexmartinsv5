...
const OBJETIVOS_IGREJA = [
  "Comprar sede ou imóvel",
  "Comprar terreno",
  "Construir",
  "Reformar ou ampliar",
  "Comprar veículos ou vans",
  "Outro projeto da igreja",
];
...
type Errors = Partial<Record<"nome" | "whatsapp" | "email" | "projeto" | "objetivo" | "modo", string>>;

export function CTAIgrejas() {
  ...
  const [projeto, setProjeto] = useState<ProjetoTipo | "">("");
  ...
  const objetivos =
    projeto === "igreja"
      ...
      : projeto === "pessoal" || projeto === "membro"
        ...
        : projeto === "ambos"
          ? [
              ...OBJETIVOS_IGREJA.map((o) => `Igreja — ${o}`),
              ...OBJETIVOS_PESSOAL.map((o) => `Pessoal — ${o}`),
            ]
          : [];
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!projeto) next.projeto = "Escolha para quem é o projeto.";
            ...
            <div className="relative grid gap-8 lg:grid-cols-[42fr_58fr] lg:items-start lg:gap-12 [&>*]:min-w-0">
              <div>
                ...
                <p className="mt-4 leading-[1.7] text-primary-foreground/70">
                  Preencha algumas informações sobre o que você deseja realizar. Vou analisar seu
                  cenário e entrar em contato para combinarmos os próximos passos.
                </p>
                <div className="mt-6">
                ...
                {enviado ? (
                  <div aria-live="polite" className="py-6 text-center">
                    ...
                    <p className="mx-auto mt-3 max-w-md leading-[1.7] text-muted-foreground">
                      Obrigado pelas informações. Vou analisar o que você me contou e entrar em
                      contato para combinarmos os próximos passos.
                    </p>
                  ...
                  <form onSubmit={handleSubmit} noValidate className="space-y-4">
                    ...
                    <fieldset className="space-y-2">
                      ...
                      {errors.projeto && (
                        <p id="erro-projeto" className="text-sm text-destructive">
                          {errors.projeto}
                        </p>
                      )}
                    </fieldset>
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="igreja-nome">Nome</Label>
                      <Input
                        id="igreja-nome"
                        value={nome}
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="space-y-1.5">
                        <Label htmlFor="igreja-whatsapp">WhatsApp</Label>
                        <Input
                          id="igreja-whatsapp"
                          type="tel"
                          inputMode="tel"
                      ...
                      <div className="space-y-1.5">
                        <Label htmlFor="igreja-email">E-mail</Label>
                        <Input
                          id="igreja-email"
                          type="email"
                          value={email}
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="igreja-objetivo">O que você está buscando?</Label>
                      <Select value={objetivo} onValueChange={setObjetivo} disabled={!projeto}>
                        <SelectTrigger
                          id="igreja-objetivo"
                        ...
                        >
                          <SelectValue
                            placeholder={
                              projeto ? "Selecione uma opção" : "Escolha primeiro para quem é o projeto"
                            }
                          />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <fieldset className="space-y-2">
                      ...
                      >
                        <div className="flex items-center gap-2 rounded-lg border border-border p-3">
                          <RadioGroupItem value="credito" id="igreja-modo-credito" />
                          <Label htmlFor="igreja-modo-credito" className="cursor-pointer font-normal">
                            Valor do crédito que procuro
                          </Label>
                        </div>
                        <div className="flex items-center gap-2 rounded-lg border border-border p-3">
                          <RadioGroupItem value="parcela" id="igreja-modo-parcela" />
                          <Label htmlFor="igreja-modo-parcela" className="cursor-pointer font-normal">
