    ...
    >
      <div className="section-shell">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-7 max-w-xl leading-[1.85] text-primary-foreground/80">
            ...
            return (
              <Reveal key={step.title} delay={index * 90} className="h-full">
                <Card className="card-lift h-full rounded-3xl border-primary-foreground/12 bg-primary-deep shadow-none">
                  <CardContent className="flex flex-col items-center p-7 text-center md:p-8">
                    <span className="grid h-14 w-14 place-items-center rounded-2xl bg-gold font-display text-2xl font-extrabold text-gold-foreground">
                      {step.letter}
                    </span>
                    <span className="mt-6 grid h-10 w-10 place-items-center rounded-full bg-primary-foreground/10">
