      ...
      <div className="section-shell grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center lg:gap-14">
        ...
        <Reveal delay={100}>
          ...
          <div className="measure mt-5 space-y-4 leading-[1.7] text-muted-foreground">
            <p>
              Minha trajetória profissional foi construída ao longo de mais de 20 anos no
              desenvolvimento de estratégias de negócios.
            </p>
            <p>
              Essa experiência me ensinou a analisar cenários, identificar oportunidades e
              transformar objetivos em planos estruturados.
            </p>
            <p>
              Hoje aplico essa visão como Consultor Autorizado Ademicon, ajudando pessoas, famílias
              e empresários a estruturar projetos patrimoniais com clareza, transparência e
              acompanhamento pessoal.
            </p>
          </div>
          <p className="measure mt-6 border-l-2 border-gold pl-4 text-base font-semibold leading-[1.65] text-primary md:text-lg">
            Você não recebe apenas uma proposta. Meu trabalho é ajudar você a entender a estratégia
            por trás da decisão.
          </p>
          <div className="mt-7 border-t border-border pt-6">
            ...
            <Button asChild variant="link" className="mt-1 h-auto p-0 text-gold">
              <a href={ADEMICON_CREDENTIAL_URL} target="_blank" rel="noopener noreferrer">
                Verificar minha credencial oficial{" "}
