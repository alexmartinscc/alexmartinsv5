            ...
            <div className="grid gap-8 lg:grid-cols-[42fr_58fr] lg:items-start lg:gap-12">
              <div>
                <h2 className="text-3xl font-extrabold text-primary-foreground md:text-[2.25rem] md:leading-[1.15]">
                  Antes de decidir, descubra se existe um caminho melhor para o seu projeto.
                </h2>
                <p className="mt-4 leading-[1.7] text-primary-foreground/75">
                  Conte-me o que você pretende realizar. Vamos entender seu cenário, suas
                  prioridades e o que merece ser comparado antes da sua decisão.
                </p>
                <div className="mt-7 border-t border-primary-foreground/15 pt-5 text-sm text-primary-foreground/70">
                  <a
                    href={`mailto:${CONTACT_EMAIL}`}
                    className="flex w-fit items-center gap-2 hover:text-primary-foreground"
                  >
                    <Mail className="h-4 w-4 text-gold" aria-hidden="true" />
                    {CONTACT_EMAIL}
                  </a>
                  <span className="mt-3 flex w-fit items-center gap-2">
              ...
              <div className="rounded-2xl bg-card p-5 md:p-7">
                {enviado ? (
                  ...
                  <form onSubmit={handleSubmit} noValidate className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="lead-prioridade">Qual é a sua prioridade?</Label>
                      ...
                      {errors.prioridade ? (
                        <p id="erro-prioridade" className="text-sm text-destructive">
                          {errors.prioridade}
                        </p>
                      ) : null}
                    </div>
                    <div className="space-y-1.5">
                      <Label htmlFor="lead-mensagem">
                        Conte brevemente o que você pretende realizar{" "}
                    ...
                    >
                      ...
                      {enviando ? "Enviando..." : "Quero descobrir minhas opções"}
                    </Button>
                    ...
                    <div className="border-t border-border pt-4 text-center">
                      <a
                        ...
                        className="inline-flex items-center gap-2 rounded-lg px-2 py-2 text-sm font-semibold text-primary underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                      >
