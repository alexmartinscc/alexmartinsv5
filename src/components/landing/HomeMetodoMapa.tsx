...
const STEPS = [
  {
    ...
    description:
      "Onde você está, o que deseja conquistar, em quanto tempo e quais recursos possui.",
  },
  {
    letter: "A",
      ...
      <div className="section-shell">
        <Reveal className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl leading-[1.7] text-primary-foreground/80">
            Uso o Método MAPA para organizar seu objetivo, prazo, recursos e possibilidades em uma
            estratégia clara — e acompanho você durante a jornada.
          </p>
        </Reveal>
          ...
          <div className="relative space-y-7 lg:grid lg:grid-cols-4 lg:gap-6 lg:space-y-0">
            {STEPS.map((step, index) => (
              ...
              >
                ...
                <p className="text-xs font-bold uppercase text-primary-foreground/60 lg:mt-3">
                  {step.label}
                </p>
                <h3 className="mt-1 text-lg font-extrabold leading-snug text-gold">{step.title}</h3>
                <p className="mt-2 text-sm font-medium leading-relaxed text-primary-foreground/85">
                  {step.description}
                </p>
              </Reveal>
            ))}
