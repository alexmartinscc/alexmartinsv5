...
export function Hero() {
  return (
    <section
      id="hero"
      className="relative isolate scroll-mt-24 overflow-hidden bg-primary-deep pt-[38vh] pb-12 md:pt-32 md:pb-20 lg:flex lg:min-h-[82vh] lg:items-center"
    >
      <picture>
      ...
      <div className="section-shell relative">
        <Reveal className="max-w-[670px]">
          ...
          <p className="mt-5 max-w-[620px] text-base leading-[1.65] text-primary-foreground/90 md:text-lg">
            Ajudo pessoas, famílias e empresários a realizar projetos de imóveis, veículos e
            patrimônio com planejamento e estratégias sem juros.
          </p>
          <p className="mt-3 max-w-[590px] text-sm leading-[1.65] text-primary-foreground/70 md:text-base">
            Antes de financiar, adiar seus planos ou tomar uma decisão, descubra o que vale a pena
            comparar.
          </p>
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            <Button
              asChild
              size="lg"
              className="w-full rounded-xl bg-gold px-7 text-gold-foreground shadow-soft hover:bg-gold/90 sm:w-auto"
            >
              <a href="#contato" data-cta-location="hero" data-cta-name="descobrir_opcoes">
                Quero descobrir minhas opções
              </a>
            </Button>
            <Button
              asChild
              size="lg"
              variant="outline"
              className="w-full rounded-xl border-primary-foreground/40 bg-primary-deep/20 px-7 text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground sm:w-auto"
            >
              <a href="#metodo" data-cta-location="hero" data-cta-name="como_trabalho">
                Como eu trabalho
              </a>
            </Button>
          </div>
